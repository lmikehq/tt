...
import { DashboardFlightBookingProps, DashboardMultiCityFlightBookingProps } from "@/lib/types/response-models/dashboard";
import { formatFlightDate, formatFlightTime } from "@/lib/extensions/helpers/flight";

type Props = {
  flight: DashboardMultiCityFlightBookingProps;
};

export const MultiFlightComp = ({ flight }: Props) => {
...
export const MobileMultiFlightComp = ({ flight }: Props) => {
  const { day, month } = formatFlightDate(flight?.departureTime);
