...
function VisaDetail({ visa, refetch }: { visa: any; refetch: any }) {
    ...
    function getLocationField(field: string) {
        return typeof visa?.primaryTraveller[field] === "string"
            ...
            : `${
                  (visa?.primaryTraveller?.[field]?.name ||
                      visa?.[field]?.name) ??
                  "Country"
              } (${
                  (visa?.primaryTraveller?.[field]?.code ||
                      visa?.[field]?.code) ??
                  "Code"
              })`;
    }
        ...
        return (
            <Logo>
                ...
                <img
                    ...
                    alt={
                        visa?.destination || visa?.primaryTraveller?.destination
                    }
                    style={{
                        height: "100%",
                        width: "100%",
            ...
            {isMobile ? (
                ...
                >
                    ...
                    <Flex direction="column" gap=".5rem">
                        ...
                        />
                        <VisaStatus
                            style={{ backgroundColor: textAndBgColor.bg }}
                        >
                            <Text
                                type="h5"
                                text={
