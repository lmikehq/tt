        ...
        <Flex direction="column" gap="20px">
          <Flex justify="space-between" align="center">
            ...
            <Flex align="center" gap="5px" justify="flex-end">
              <PeopleAltIcon />
              <Text type="p" text="2 Adults"></Text>
            </Flex>
          </Flex>
          <Flex justify="space-between" align="center">
            <Flex>
              <Text type="p" text="5 nights" whiteSpace="nowrap"></Text>
            </Flex>
            <Flex gap="5px" align="center" justify="flex-end">
              <Text type="p" size={18} weight={600} text={getCurrency()} />
              <Text
                type="p"
                size={18}
                weight={600}
          ...
          <Flex justify="space-between" align="center">
            <Flex>
              <Text type="p" text="Taxes & Fees" whiteSpace="nowrap"></Text>
            </Flex>
            <Flex gap="5px" align="center" justify="flex-end">
              <Text type="p" size={18} weight={600} text={getCurrency()} />
              <Text
              ...
              <Flex justify="space-between" align="center">
                ...
                <Flex gap="5px" align="center" justify="flex-end">
                  ...
                  <Text
                    ...
                    size={18}
                    weight={600}
                    text={formatPriceWithoutCurrency(15800)}
                  />
                </Flex>
              </Flex>
              <Flex justify="space-between" align="center">
