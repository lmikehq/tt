...
function SearchBox() {
  ...
  const options = [
    { value: "guest", displayValue: "Select guest" },
    { value: "2 adult", displayValue: "2 Adult" },
    { value: "3 children", displayValue: "3 Children" },
      ...
      <Flex direction="column">
        ...
        <Flex>
          <Flex
            ...
            styles={{ marginBottom: "1.2rem" }}
          >
            <Text type="label" size={16} text="Guests & Rooms" weight={400} />
            <Dropdown
              options={options}
        ...
        <Flex>
          <Button
            ...
            margin=".5rem 0"
            color="white"
            background={submissionState.loading ? ttColors.dark : ttColors.dark}
