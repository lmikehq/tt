        ...
        >
          ...
          >
            ...
            <Flex width="100%" direction="column" gap="1rem">
              ...
              <Flex gap={isMobile ? "1rem" : "1.2rem"} justify="space-between">
                <Text
                  width="16%"
                  type="p"
                  size={isMobile ? 15 : 18}
                  weight={700}
                  text={dayjs(startRoute.utc_departure).format("HH: mm")}
                ...
                >
                  <Text
                    ...
                    size={isMobile ? 14 : 16}
                    text={
                      flightState?.airports[startRoute.flyFrom]?.name ??
              ...
              <Flex align={"center"} gap="1rem">
                ...
                {props.stops > 0 && (
                  <StopsPill numberOfStops={props.stops} isMobile={isMobile} />
                )}
              </Flex>
              <Flex gap={isMobile ? "1rem" : "1.4rem"} justify="space-between">
                ...
                >
                  <Text
                    ...
                    size={isMobile ? 14 : 16}
                    text={
                      flightState?.airports[endRoute.flyTo]?.name ??
                      props.flight.flyTo
                    }
                  />
                </Flex>
                <Text
                  ...
                  size={isMobile ? 15 : 16}
                  text={
                    isRoundTrip ? startRoute.cityCodeTo : endRoute.cityCodeTo
                  }
                  weight={500}
                  styles={{ minWidth: "max-content" }}
                  color={ttColors.lighterGray}
                ...
                <Flex direction="column" gap="1rem" margin="0 1rem">
                  ...
                  <Flex gap={isMobile ? "1rem" : "0"} justify="space-between">
                    <Text
                      ...
                      size={isMobile ? 15 : 16}
                      weight={"bold"}
                      text={dayjs(endRoute.utc_departure).format("HH: mm")}
                    />
                    <Text
                      type="p"
                      size={isMobile ? 14 : 16}
                      text={flightState?.airports[endRoute.flyFrom]?.name ?? ""}
                    />
                    <Text
                      type="p"
                      size={isMobile ? 15 : 16}
                  ...
                  >
                    <Text
                      ...
                      size={isMobile ? 15 : 16}
                      weight={"bold"}
                      text={dayjs(endRoute.utc_arrival).format("HH: mm")}
                    />
                    <Text
                      type="p"
                      size={isMobile ? 14 : 16}
                      text={flightState?.airports[endRoute.flyTo]?.name ?? ""}
                    />
                    <Text
                      type="p"
                      size={isMobile ? 15 : 16}
