    ...
    const chatItem = [
        {
            ...
            icon: (
                <Image src={"/assets/images/Vector.svg"} alt="message icon" />
            ),
            width: "145px",
        },
        {
                ...
                <main>
                    {!isMobile && (
                        <>
                            <Text
                                type="h3"
                                text="Thrillers Travels AI Travel Guide"
                            />
                            <Text
                                type="p"
                                text="First AI powered travel consultant"
                            />
                            <SearchArea>
                                <Input
                                    type="text"
                                ...
                                <BsSearch
                                    onClick={(_x) =>
                                        filterChatItems(searchCriteria)
                                    }
                                    size="1rem"
                                    color="#A3A3A3"
