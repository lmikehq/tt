...
} from "@lib/extensions/data/utilData";
...
const sectionDesc = {
    A: "Comprises Principal family members (Father and Mother)",
        ...
        <Section height="unset" margin="0 0 0rem">
                ...
                <Flex align="flex-start" margin="0 0 1rem">
                    <Flex direction="column" justify="flex-start" gap="1rem">
                        <Text
                            ...
                            text={`${
                                sectionName[
                                    values?.section as keyof typeof sectionName
                                ]
                            }`}
                            size={20}
                            weight={600}
                        ...
                        <Text
                            ...
                            text={
                                sectionDesc[
                                    values?.section as keyof typeof sectionDesc
                                ]
                            }
                            size={16}
                        />
                    ...
                    <AddButton
                        disabled={
                            formik.values.familyMembers.filter(
                                (v: any) => v?.section === values?.section
                            ).length ===
                            (values?.section === "C"
                                ? 10
                                : values?.section === "A"
                        ...
                        onClick={() => {
                            ...
                            if (
                                formik.values.familyMembers.filter(
                                    (v: any) => v?.section === values?.section
                                ).length < (values?.section === "C" ? 10 : 3)
                            ) {
                                arrayHelpers?.insert(count + 1, {
                                    ...familyInforKeys,
                                    section: values?.section,
                                    index: formik.values.familyMembers.filter(
                                        (e: FamilyInfoInterface) =>
                                            e.section === values?.section
                                    ).length,
                                });
                            }
                        }}
            ...
            {values?.section === "A" && (
                <React.Fragment>
                    ...
                    >
                        <Flex align="center">
                            <Text type="p" text="Is alive" />
                            <Switch
                                name={`familyMembers.${count}.isAlive`}
                        ...
                        {values?.isAlive === false && (
                            <Section margin="0">
                                <Flex
                                    ...
                                    margin="0 0 .5rem"
                                >
                                    <Text type="p" text="Date of Death" />
                                    <Required />
                                </Flex>
                                <FieldAsDate
                                    name={`familyMembers.${count}.dateOfDeath`}
