    ...
    return (
        <Section>
            ...
            />
                ...
                {formik.values.meansOfId == "Driver's License" ||
                formik.values.meansOfId == "Voter ID Card" ||
                formik.values.meansOfId == "Resident Permit/Visa" ||
                formik.values.meansOfId == "Health Insurance Card" ? (
                    <Flex
                        justify="space-between"
                        direction={isMobile ? "column" : "row"}
                        gap={isMobile ? "0px" : "1.5rem"}
                    >
                        <Section width="100%">
                            <Text
                                ...
                                text="Issue Date"
                                margin={
                                    isMobile ? ".7rem  0 .2rem" : "1rem 0 .3rem"
                                }
                                size={15}
                            />
                            <FieldAsDate
                ...
                {String(formik.values.livedAbroad) === "true" && (
                    <React.Fragment>
                        ...
                        {Number(formik.values.countriesLived) > 0 &&
                            Array.from({
                                length: Math.min(
                                    Number(formik.values.countriesLived),
                                    5
                                ),
                            }).map((e, ind) => (
                                <React.Fragment key={`prev-res-${ind}`}>
                                    <Section>
                                        <Flex align="center" gap="0.25rem">
                                            <Text
                                                type="p"
                    ...
                    >
                        ...
                        <Section>
                            ...
                            <FieldAsDate
                                ...
                                format="DD/MM/YYYY"
                                minDate={dayjs(
                                    formik.values.passportIssuedDate,
                                    "DD/MM/YYYY"
                                )}
                            />
                        </Section>
                        ...
                        <Section>
                            <Flex align="center" gap="0.25rem">
                                <Text
                                    ...
                                    text="Partner's Name"
                                    margin={
                                        isMobile ? ".5rem 0" : "1rem 0px 0.5rem"
                                    }
                                    size={15}
                                />
                                <Required />
                ...
                <Section>
                    ...
                    />
                    {formik.touched["tripPurpose"] &&
                        formik.errors["tripPurpose"] && (
                ...
                >
                    ...
                    <Section width="100%">
                        ...
                        <FieldAsDate
                            ...
                            format="DD/MM/YYYY"
                            minDate={
                                !!formik.values.tripDurationStartDate
                                    ? dayjs(formik.values.tripDurationStartDate)
                                    : dayjs()
                            }
                            styles={{ paddingBottom: "0" }}
                        />
                ...
                <Section margin={isMobile ? "0" : "0 0 0 .9rem"}>
                    <ol>
                            ...
                            >
                                ...
                                <Section height="auto" width="fit-content">
                                    <CustomRadioGroup
                                        ...
                                        value={
                                            formik.values.remainbeyondValidity
                                        }
                                        onChange={formik.handleChange}
                                        onBlur={formik.handleBlur}
                                        justifyContent="flex-end"
                        ...
                        {String(formik.values.remainbeyondValidity) ==
                            "true" && (
                            <Section>
                                <Text
                                    size={16}
                        ...
                        {`${formik.values.servedInMilitary}` == "true" && (
                            <Section>
                                ...
                                <TextArea
                                    ...
                                    value={
                                        formik.values.servedInMilitaryDetails
                                    }
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur}
                                />
                            ...
                            >
                                ...
                                <Section height="auto" width="fit-content">
                                    <CustomRadioGroup
                                        ...
                                        value={
                                            formik.values.memberOfViolentGroup
                                        }
                                        onChange={formik.handleChange}
                                        onBlur={formik.handleBlur}
                                        justifyContent="flex-end"
                        ...
                        {String(formik.values.memberOfViolentGroup) ==
                            "true" && (
                            <Section>
                                <Text
                                    size={16}
                        ...
                        {String(
                            formik.values.participatedInViolentActivities
                        ) == "true" && (
                            <Section>
                                <Text
                                    size={16}
