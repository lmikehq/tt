...
return (
    <Section padding=".75rem 0 0 0 " height="unset">
        ...
        >
            ...
            >
                <Text type="label" size={isMobile ? 16 : 16} text="From" weight={500} />
                <SearchInput
            ...
            <Flex
                ...
                styles={{ marginBottom: isMobile ? "1.2rem" : "0" }}
            >
                <Text type="label" size={isMobile ? 16 : 16} text="To" weight={500} />
                <SearchInput
                    options={COUNTRY_FLAGS.map((x) => ({
                        name: x.name,
                        flag: x.flag,
            ...
            <Flex
                ...
                styles={{ marginBottom: isMobile ? "1.2rem" : "0" }}
            >
            <Text type="label" size={isMobile ? 16 : 16} text="Depart" weight={500} />
            <DatePicker
