...
const data = [
  ...
  },
  {
    ...
    flex: (
      <Button variant="solid" background={ttColors.dark}>
        Select
      </Button>
    ),
    superFlex: (
          ...
          {data.map((row, index) =>
            row.isButtonRow ? (
              ...
              <StyledTableRow key={row.feature}>
                ...
                <StyledTableCell>{row.superFlex}</StyledTableCell>
              </StyledTableRow>
            )
          )}
        </TableBody>
