...
const CustomPopover = ({ user, isLoading }: Props) => {
    ...
    const { notifications, resetNotifications } = useNotificationStore(
        (state) => state
    );
                                            ...
                                            >
                                                ...
                                                >
                                                    <Flex
                                                        ...
                                                        onClick={async () => {
                                                            const response =
                                                                await NotificationService.markAllNotification();
                                                            if (
                                                                response.success ===
                                                                    true ||
                                                                response.message ===
                                                                    "all user notifications read"
                                                            ) {
                                                                toast.success(
                                                                    "Notifications Read"
                                                                );
                            ...
                            {user && user?.profilePicture ? (
                                <img
                                    ...
                                    style={{
                                        ...
                                        maxWidth: "54px",
                                        maxHeight: "54px",
                                        border: "2px solid var(--Slamon, #FF8682)",
                                    }}
                                />
                            ) : (
                                <RxAvatar size={48} />
