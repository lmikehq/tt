...
const postCard = {
    heading:
        "Embark on Unforgettable Journeys with Thrillers Travels:  Your Passport to Limitless Exploration",
...
export const coreValues = [
    {
        heading: "Excellence",
        text: "Striving for exceptional quality in every aspect of our services.",
    },
    {
        heading: "Customer-Centric",
        text: "Putting our clients first by understanding their needs.",
    },
    {
        heading: "Integrity",
        text: "Being honest and transparent in all of our operations.",
    },
    {
        heading: "Innovation",
        text: "Embracing creativity and forward-thinking.",
    },
];
const bulletPoints = [
    {
...
const timeline = [
    {
        ...
        content:
            "Thrillers Travels begins operations by offering expert visa facilitation services, becoming a trusted advisor in navigating intricate visa processes.",
    },
    {
        ...
        content:
            "Over a year and a half, Thrillers Travels meticulously crafts and hones its suite of travel solutions, including personalized itineraries, accommodations, and streamlined visa services, refining its offerings to meet the diverse needs of travelers.",
    },
    {
        ...
        content:
            "Thrillers Travels focuses on establishing strategic partnerships with accommodation providers, expanding its reach, and conducting thorough market research to prepare",
    },
    {
        ...
        content:
            "A monumental day as Thrillers Travels officially launches its platform, marking a significant milestone in its journey to redefine travel experiences. The platform goes live, offering travelers a seamless and curated approach to travel, stays, and visa solutions.",
    },
    {
...
function SubHeading({
    ...
    return (
        <Flex direction="column" gap="1rem">
            <Text type="h2" text={title} size={26} weight={600} />
            <Text type="p" text={text} size={15} />
            {sub}
        </Flex>
    );
}
...
function AboutUsPage() {
    ...
    const { getAllBlogs, blogs } = useBlogStore((state) => state);
    useEffect(() => {
            ...
            <Flex direction="column" gap="3.5rem" margin="3rem 0">
                ...
                >
                    {bulletPoints.map((bullet, index) => (
                        <BulletCard key={`bullet-${index}`} {...bullet} />
                    ))}
                </Box>
                ...
                <Section>
                    ...
                    />
                    <ValuesCarousel items={coreValues} />
                </Section>

                <Section
                    background={ttColors.primary100}
                    padding={isMobile ? "4rem 2rem 5rem" : "4rem 3rem 5rem"}
                    overflow="visible"
                >
                    <SubHeading
                        title="Our Story"
