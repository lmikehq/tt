      ...
      <Document>
        ...
        <Page size="A4" style={[styles.page_one, styles.firstPage, styles.body]}>
          ...
          <View style={styles.footer}>
            <Text style={styles.footer_text}>Page 1 of 8</Text>
          </View>
        </Page>
        ...
        <Page size="A4">
          <View style={{ margin: '10px 20px' }}>
              ...
              <Flex direction="row">
                ...
                <Flex width="40%" borderLeft="none" borderTop="none" padding="0px 10px">
                  <Flex direction="row">
                    <Flex direction="row">
                      <Flex direction="row">
                        {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: `${data?.primaryTraveller?.personalDetails?.firstName ? '#000' : ''}` }}> </Section> */}
              ...
              <Flex border="1px solid #000" borderTop="" padding="0 10px">
                ...
                <Box>
                  <Flex direction="row" justify="flex-end">
                    <Flex direction="row">
                      {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: data?.primaryTraveller?.citizenshipInformation?.previousCountryOfResidences.length > 0 ? '#000' : '' }}> </Section> */}
                      <Text style={[styles.text_sm]}> Yes </Text>
                    </Flex>
            ...
            <Box>
              <Flex direction="row" gap="24px" border="1px solid #000" borderTop="" padding="0 10px">
                ...
                <Flex direction="row" justify="flex-end">
                  <Flex direction="row">
                    {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: `${data?.primaryTraveller?.citizenshipInformation?.countryApplyingFrom?.name === data?.primaryTraveller?.citizenshipInformation?.countryOfResidence?.name ? '#000' : ''}` }}> </Section> */}
                    <Text style={[styles.text_sm]}> Yes </Text>
                  </Flex>
          ...
          {/* add footer page 1 */}
          <View style={styles.footer}>
            <Text style={styles.footer_text}>Page 2 of 8</Text>
          </View>
        </Page>
        ...
        <Page size="A4">
          ...
          <View style={styles.footer}>
            <Text style={styles.footer_text}>Page 3 of 8</Text>
          </View>
        </Page>
        ...
        <Page size="A4">
          ...
          <View style={styles.footer}>
            <Text style={styles.footer_text}>Page 4 of 8</Text>
          </View>
        </Page>
        ...
        <Page size="A4">
            ...
            <Box margin="5px 0">
              ...
              <Flex border="1px solid #000" padding="0 10px">
                <Flex padding="10px 0">
                  ...
                  <Flex direction="row" justify="flex-end">
                    <Flex direction="row">
                      {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: `${data.primaryTraveller.backgroundInformation.tuberculosis === 'true' ? '#000' : ''}` }}> </Section> */}
                      <Text style={[styles.text_sm]}> Yes </Text>
                    </Flex>
                ...
                <Flex padding="10px 0">
                  ...
                  <Flex direction="row" justify="flex-end">
                    <Flex direction="row">
                      {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: `${data.primaryTraveller.backgroundInformation.mentalDisorder === 'true' ? '#000' : ''}` }}> </Section> */}
                      <Text style={[styles.text_sm]}> Yes </Text>
                    </Flex>
              ...
              <Flex border="1px solid #000" padding="0 10px 30px">
                <Flex padding="10px 0">
                  ...
                  <Flex direction="row" justify="flex-end">
                    ...
                    <Flex direction="row">
                      {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: `${data.primaryTraveller.backgroundInformation.remainbeyondValidity === 'false' ? '#000' : ''}` }}> </Section> */}
                      <Text style={[styles.text_sm]}> No </Text>
                    </Flex>
                  </Flex>
                </Flex>
                ...
                <Flex padding="10px 0">
                  ...
                  <Flex direction="row" justify="flex-end">
                    <Flex direction="row">
                      {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: `${data.primaryTraveller.backgroundInformation.refusedBefore === 'true' ? '#000' : ''}` }}> </Section> */}
                      <Text style={[styles.text_sm]}> Yes </Text>
                    </Flex>

                    <Flex direction="row">
                      {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: `${data.primaryTraveller.backgroundInformation.refusedBefore === 'false' ? '#000' : ''}` }}> </Section> */}
                      <Text style={[styles.text_sm]}> No </Text>
                    </Flex>
                  </Flex>
                </Flex>
          ...
          <View style={styles.footer}>
            <Text style={styles.footer_text}>Page 5 of 8</Text>
          </View>
        </Page>
        ...
        <Page size="A4">
          <View style={{ margin: '10px 20px' }}>
            ...
            <Flex border='1px solid #000' padding='0 10px 100px'>
              ...
              <Flex direction="row" justify="flex-end">
                <Flex direction="row">
                  {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: `${data.primaryTraveller.backgroundInformation.arrestedBefore === 'true' ? '#000' : ''}` }}> </Section> */}
                  <Text style={[styles.text_sm]}> Yes </Text>
                </Flex>

                <Flex direction="row">
                  {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: `${data.primaryTraveller.backgroundInformation.arrestedBefore === 'false' ? '#000' : ''}` }}> </Section> */}
                  <Text style={[styles.text_sm]}> No </Text>
                </Flex>
              </Flex>
            ...
            <Flex margin='0px 0 0px' padding='10px 0px 140px' border='1px solid #000'>
              <Flex>
                ...
                <Flex direction="row" justify="flex-end">
                  <Flex direction="row">
                    {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: `${data.primaryTraveller.backgroundInformation.servedInMilitary === 'true' ? '#000' : ''}` }}> </Section> */}
                    <Text style={[styles.text_sm]}> Yes </Text>
                  </Flex>

                  <Flex direction="row">
                    {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: `${data.primaryTraveller.backgroundInformation.servedInMilitary === 'false' ? '#000' : ''}` }}> </Section> */}
                    <Text style={[styles.text_sm]}> No </Text>
                  </Flex>
                </Flex>
              </Flex>
            ...
            <Flex direction='column' borderLeft='1px solid #000' borderRight='1px solid #000'>
              ...
              <Flex direction="row">
                <Flex direction="row" justify="flex-end">
                  <Flex direction="row">
                    {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: `${data.primaryTraveller.backgroundInformation.participatedInViolentActivities === 'true' ? '#000' : ''}` }}> </Section> */}
                    <Text style={[styles.text_sm]}> Yes </Text>
                  </Flex>

                  <Flex direction="row">
                    {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '10px', backgroundColor: `${data.primaryTraveller.backgroundInformation.participatedInViolentActivities === 'false' ? '#000' : ''}` }}> </Section> */}
                    <Text style={[styles.text_sm]}> No </Text>
                  </Flex>
                </Flex>
              </Flex>
          ...
          <View style={styles.footer}>
            <Text style={styles.footer_text}>Page 6 of 8</Text>
          </View>
        </Page>
        ...
        <Page size="A4">
          <View style={{ margin: '10px 20px' }}>
            <Box>
              ...
              <Flex direction='row' gap='10px' styles={{ margin: '10px 0' }}>
                ...
                <Flex direction='row' gap='10px'>
                  {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '20px', backgroundColor: `${data.visaType === 'visitor' ? '#000' : ''}` }}> </Section> */}
                  <Text style={styles.text_sm}>Visitor</Text>
                </Flex>
                <Flex direction='row' gap='10px'>
                  {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '20px', backgroundColor: `${data.visaType === 'working' ? '#000' : ''}` }}> </Section> */}
                  <Text style={styles.text_sm}>Worker</Text>
                </Flex>
                <Flex direction='row' gap='10px'>
                  {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '20px', backgroundColor: `${data.visaType === 'student' ? '#000' : ''}` }}> </Section> */}
                  <Text style={styles.text_sm}>Student</Text>
                </Flex>
                <Flex direction='row' gap='10px'>
                  {/* <Section styles={{ border: '1px solid #000', height: '10px', width: '20px', backgroundColor: `${!['visitor', 'working', 'student'].includes(data.visaType) ? '#000' : ''}` }}> </Section> */}
                  <Text style={styles.text_sm}>Other</Text>
                </Flex>
              </Flex>
            ...
            <Box>
              ...
              <Flex direction='row' borderBottom='1px solid #000' borderLeft='1px solid #000' borderRight='1px solid #000' height='60px'>
                ...
                {/* <Flex direction='row' gap='10px' align='center' justify='center' styles={{ width: '20%' }}>
                  <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: `${'true' === 'true' ? '#000' : ''}` }}> </Section>
                  <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: `${'true' === 'true' ? '#000' : ''}` }}> </Section>
                </Flex> */}
              </Flex>
              ...
              <Flex direction='row' borderBottom='1px solid #000' borderLeft='1px solid #000' borderRight='1px solid #000' height='60px'>
                ...
                <Flex direction='row' gap='10px' align='center' justify='center' styles={{ width: '20%' }}>
                  {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: getFamilyMember(renderFamilyMember(data, 'Immediate')!, 'Spouse')?.[0]?.accompanying === true ? '#000' : '' }}> </Section> */}
                  {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: getFamilyMember(renderFamilyMember(data, 'Immediate')!, 'Spouse')?.[0]?.accompanying === false ? '#000' : '' }}> </Section> */}
                </Flex>
              </Flex>
              ...
              <Flex direction='row' borderBottom='1px solid #000' borderLeft='1px solid #000' borderRight='1px solid #000' height='60px'>
                ...
                <Flex direction='row' gap='10px' align='center' justify='center' styles={{ width: '20%' }}>
                  {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: getFamilyMember(renderFamilyMember(data, 'Parent')!, 'Mother')?.[0]?.accompanying === true ? '#000' : '' }}> </Section> */}
                  {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: getFamilyMember(renderFamilyMember(data, 'Parent')!, 'Mother')?.[0]?.accompanying === false ? '#000' : '' }}> </Section> */}
                </Flex>
              </Flex>
              ...
              <Flex direction='row' borderBottom='1px solid #000' borderLeft='1px solid #000' borderRight='1px solid #000' height='60px'>
                ...
                <Flex direction='row' gap='10px' align='center' justify='center' styles={{ width: '20%' }}>
                  {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: getFamilyMember(renderFamilyMember(data, 'Parent')!, 'Father')?.[0]?.accompanying === true ? '#000' : '' }}> </Section>
                  <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: getFamilyMember(renderFamilyMember(data, 'Parent')!, 'Father')?.[0]?.accompanying === false ? '#000' : '' }}> </Section> */}
                </Flex>
              </Flex>
            ...
            <Box>
              ...
              <Flex direction='row' borderBottom='1px solid #000' borderLeft='1px solid #000' borderRight='1px solid #000' height='60px'>
                ...
                <Flex align='center' justify='center' styles={{ width: '10%', borderRight: '1px solid #000' }}>
                  <Text style={[styles.text_response]}>
                    {/* {getFamilyMember(data?.familyInformation?.immediateFamilyInfo, 'Children')?.[0]?.status} */}
                  </Text>
                </Flex>
                <Flex align='center' direction='column' justify='center' styles={{ width: '25%', borderRight: '1px solid #000' }}>
                  <Text style={[{ borderBottom: '1px solid #000' }, styles.text_response]}>
                ...
                <Flex direction='row' gap='10px' align='center' justify='center' styles={{ width: '20%' }}>
                  {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: getFamilyMember(data?.familyInformation?.immediateFamilyInfo, 'Children')?.[0]?.accompanying === true ? '#000' : '' }}> </Section> */}
                  {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: getFamilyMember(data?.familyInformation?.immediateFamilyInfo, 'Children')?.[0]?.accompanying === false ? '#000' : '' }}> </Section> */}
                </Flex>
              </Flex>
              ...
              <Flex direction='row' borderBottom='1px solid #000' borderLeft='1px solid #000' borderRight='1px solid #000' height='60px'>
                ...
                <Flex direction='row' gap='10px' align='center' justify='center' styles={{ width: '20%' }}>
                  {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: getFamilyMember(data?.familyInformation?.immediateFamilyInfo, 'Children')?.[1]?.accompanying === true ? '#000' : '' }}> </Section> */}
                  {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: getFamilyMember(data?.familyInformation?.immediateFamilyInfo, 'Children')?.[1]?.accompanying === false ? '#000' : '' }}> </Section> */}
                </Flex>
              </Flex>
            </Box>
          </View>
          <View style={styles.footer}>
            <Text style={styles.footer_text}>Page 7 of 8</Text>
          </View>
        </Page>
        ...
        <Page size="A4">
          <View style={{ margin: '10px 20px' }}>
            {/* ANSWER FOR CHILD 2 */}
            {/* <Flex direction='row' borderTop='1px solid #000' borderLeft='1px solid #000' borderRight='1px solid #000' height='60px'>
              <Flex align='center' justify='center' styles={{ width: '25%', borderRight: '1px solid #000' }}>
                <Text style={styles.text_response}>{getFamilyMember(data?.familyInformation?.immediateFamilyInfo, 'Children')?.[1]?.membersName}</Text>
              </Flex>
              <Flex align='center' justify='center' styles={{ width: '10%', borderRight: '1px solid #000' }}>
              ...
              <Flex align='center' direction='column' justify='center' styles={{ width: '10%', borderRight: '1px solid #000' }}>
                <Text style={[{ borderBottom: '1px solid #000' }, styles.text_response]}>
                  {getFamilyMember(data?.familyInformation?.immediateFamilyInfo, 'Children')?.[1]?.dateOfBirth !== undefined ? getFamilyMember(data?.familyInformation?.immediateFamilyInfo, 'Children')?.[1]?.dateOfBirth : ''}
                </Text>
                <Text style={styles.text_response}>
                  {getFamilyMember(data?.familyInformation?.immediateFamilyInfo, 'Children')?.[1]?.address}
                </Text>
            ...
            <Flex direction='row' border='1px solid #000' height='60px'>
              ...
              <Flex direction='row' gap='10px' align='center' justify='center' styles={{ width: '20%' }}>
                {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: getFamilyMember(data?.familyInformation?.immediateFamilyInfo, 'Children')?.[2]?.accompanying === true ? '#000' : '' }}> </Section>
                <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: getFamilyMember(data?.familyInformation?.immediateFamilyInfo, 'Children')?.[2]?.accompanying === false ? '#000' : '' }}> </Section> */}
              </Flex>
            </Flex>
            ...
            <Flex direction='row' borderBottom='1px solid #000' borderLeft='1px solid #000' borderRight='1px solid #000' height='60px'>
              ...
              <Flex direction='row' gap='10px' align='center' justify='center' styles={{ width: '20%' }}>
                {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: renderFamilyMember(data, 'Children')?.[3]?.accompanying === true ? '#000' : '' }}> </Section>
                <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: renderFamilyMember(data, 'Children')?.[3]?.accompanying === false ? '#000' : '' }}> </Section> */}
              </Flex>
            </Flex>
            ...
            <Box>
              ...
              <Flex direction='row' borderBottom='1px solid #000' borderLeft='1px solid #000' borderRight='1px solid #000' height='70px'>
                <Flex align='center' justify='center' styles={{ width: '25%', borderRight: '1px solid #000' }}>
                ...
                <Flex direction='row' gap='10px' align='center' justify='center' styles={{ width: '20%' }}>
                  {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: renderFamilyMember(data, 'Sibling')?.[0]?.accompanying === true ? '#000' : '' }}> </Section>
                  <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: renderFamilyMember(data, 'Sibling')?.[0]?.accompanying === false ? '#000' : '' }}> </Section> */}
                </Flex>
              </Flex>
              ...
              <Flex direction='row' borderBottom='1px solid #000' borderLeft='1px solid #000' borderRight='1px solid #000' height='70px'>
                ...
                <Flex direction='row' gap='10px' align='center' justify='center' styles={{ width: '20%' }}>
                  {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: renderFamilyMember(data, 'Sibling')?.[1]?.accompanying === true ? '#000' : '' }}> </Section>
                  <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: renderFamilyMember(data, 'Sibling')?.[1]?.accompanying === false ? '#000' : '' }}> </Section> */}
                </Flex>
              </Flex>
              ...
              <Flex direction='row' borderBottom='1px solid #000' borderLeft='1px solid #000' borderRight='1px solid #000' height='70px'>
                ...
                <Flex direction='row' gap='10px' align='center' justify='center' styles={{ width: '20%' }}>
                  {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: renderFamilyMember(data, 'Sibling')?.[2]?.accompanying === true ? '#000' : '' }}> </Section>
                  <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: renderFamilyMember(data, 'Sibling')?.[2]?.accompanying === false ? '#000' : '' }}> </Section> */}
                </Flex>
              </Flex>
              ...
              <Flex direction='row' borderBottom='1px solid #000' borderLeft='1px solid #000' borderRight='1px solid #000' height='70px'>
                ...
                <Flex direction='row' gap='10px' align='center' justify='center' styles={{ width: '20%' }}>
                  {/* <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: renderFamilyMember(data, 'Sibling')?.[3]?.accompanying === true ? '#000' : '' }}> </Section>
                  <Section styles={{ border: '1px solid #000', height: '15px', width: '20px', backgroundColor: renderFamilyMember(data, 'Sibling')?.[3]?.accompanying === false ? '#000' : '' }}> </Section> */}
                </Flex>
              </Flex>
            </Box>
          ...
          <View style={styles.footer}>
            <Text style={styles.footer_text}>Page 8 of 8</Text>
          </View>
        </Page>
